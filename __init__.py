...
resume_json = {
        ...
        'source' : 'I found Perka first on AngelList. I did more research about your company on your own website and it looks like a fantastic place to grow a career!',
...
req = urllib.request.Request('https://api.perka.com/1/communication/job/apply')
